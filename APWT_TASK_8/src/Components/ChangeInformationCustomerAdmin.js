...
const ChangeInformationCustomerAdmin = () => {
  const { id } = useParams();
  ...
  useEffect(() => {
    ...
    axios
      .post("/admin/customerinformation", object)
      .then((resp) => {
        setName(resp.data.name);

        setPhone(resp.data.phone);
        setDob(resp.data.email);
  ...
  const EditSubmit = () => {
    ...
    console.log(obj);
    axios
      .post("/admin/customerchangeinformation", obj)
      .then((resp) => {
...
export default ChangeInformationCustomerAdmin;
